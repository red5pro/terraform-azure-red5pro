...
# NODE_GROUP_CLOUD_PLATFORM="OCI" # AWS, GCP, LINODE, OCI, AZURE
...
CLOUD_PROPERTIES_AZURE="environment=$NODE_GROUP_ENVIRONMENT;vpc=$NODE_GROUP_VPC_NAME;security_group=$NODE_GROUP_SECURITY_GROUP_NAME"
...
"GCP")
    ...
    ;;
"AZURE")
    CLOUD_PROPERTIES=$CLOUD_PROPERTIES_AZURE
    ;;
"LINODE")
